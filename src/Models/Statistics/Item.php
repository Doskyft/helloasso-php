...
class Item implements HelloassoObject
{
    ...
    public function getTierDescription(): int
    {
        return $this->tierDescription;
    }

    public function setTierDescription(int $tierDescription): self
    {
